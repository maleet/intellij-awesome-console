...
public class AwesomeLinkFilterTest extends BasePlatformTestCase {
    ...
    @Test
    public void testAspNetCore() {
        assertPathDetection("at async Task<List<T>> Leanest.Salvest.Shared.Services.OdataClientExtensions.GetAllAsync<T>(ODataClient odata, string url) in D:/Repos/leanest/mes/src/WebApi/Salvest/Leanest.Salvest.Shared/Services/OdataClientExtensions.cs:line 41\n",
                "D:/Repos/leanest/mes/src/WebApi/Salvest/Leanest.Salvest.Shared/Services/OdataClientExtensions.cs", 41);
    }
